    ...
    with tempfile.TemporaryDirectory(prefix='gs-',dir='/tmp') as temp:
        ...
        try:
            ...
            result=dict(scope=__doc__,passed=soak_pass,transport_passed=transport_pass,transport_complete=complete,full_product_approval=False,
                ...
                threads=a.threads,beam_size=a.beam,wait_policy='PASSIVE',exit_code=proc.returncode,timeout=timeout,
                runtime=runtime,core=core,capture=capture_summary,buffer_observations=[e for e in events if e['event']=='buffer_state'],
